...
:: 1033 is English UK
set InstallerLocation="Z:\SOFTWARE\VLC\vlc-3.0.11-win64.exe"  
:: Install location (Case and slash sensitive)

echo:
echo:
echo Installing VLC media player version 3.0.11. This prompt will automatically close itself after installation.
echo:
